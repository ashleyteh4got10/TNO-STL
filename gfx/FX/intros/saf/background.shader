	...
	[[
		float4 main( VS_OUTPUT v ) : PDX_COLOR
		{
			...
			else if(vTime >= 10.f && vTime < 12.f)
			{
				...
				finalColour.r = (OutColor.r * OutColor.a / finalColour.a) + (black.r * black.a * (1 - OutColor.a) / finalColour.a);
				finalColour.g = (OutColor.g * OutColor.a / finalColour.a) + (black.g * black.a * (1 - OutColor.a) / finalColour.a);
				finalColour.b = (OutColor.b * OutColor.a / finalColour.a) + (black.b * black.a * (1 - OutColor.a) / finalColour.a);
				return finalColour;
			}
